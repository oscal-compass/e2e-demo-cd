...
NIST_CATALOG = --nist-catalog catalogs/NIST_800-53_rev5/catalog.json
...
CSV_VAL_TITLE = --nist-csv-validation-component-title "oscal"

CSV_PROF_SRC = --nist-csv-profile-source catalogs/NIST_800-53_rev5/catalog.json
CSV_PROF_DESC = --nist-csv-profile-description "NIST SP 800-53 Rev 5"
...
comp-defs:
	...
	python python/cisb_to_nist_cd.py $(CIS_YML) $(CIS_MAP) $(CIS_CD) $(CSV_SW) $(CSV_SW_TITLE) $(CSV_VAL) $(CSV_VAL_TITLE) $(CSV_PROF_SRC) $(CSV_PROF_DESC) $(NIST_CATALOG); \
